window.FontAwesomeCdnConfig = {
    ...
    useUrl: "cdn.onyxcentersource.com/static/fonts/onyx-font-awesome/4.7.0",
    faCdnUrl: "https://cdn.onyxcentersource.com/static/fonts/onyx-font-awesome/4.7.0",
    code: "fontawesome"
};
! function() {
    function a(a) {
	...
	! function() {
        ...
        function c(a) {
            this.a = m, this.b = undefined, this.f = [];
            var b = this;
            try {
                a(function(a) {
                    f(b, a)
    ...
    try {
        if (window.FontAwesomeCdnConfig) {
			...
			j.asyncLoading.enabled ? h.loadAsync(cssUrl) : h.load(cssUrl), g.observe([{
                familyName: n,
                testString: p
            }], {
